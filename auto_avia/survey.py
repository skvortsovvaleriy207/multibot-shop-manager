...
from handler_integration import handle_besthome_integration, handle_wond_integration_callback
...
@dp.callback_query(F.data == "besthome_equipment_links")
async def besthome_equipment_links(callback: CallbackQuery):
    text = "выберите кнопку для перехода:"
    builder = InlineKeyboardBuilder()
    builder.add(types.InlineKeyboardButton(
        text="чат-бот BestHome",
        callback_data=f"handle_besthome_integration"
    ))
    builder.add(types.InlineKeyboardButton(
        text="канал",
        url="https://t.me/+vz7-Ko4rDy03Yjhi"
    ...
    builder.add(types.InlineKeyboardButton(
        text="группа",
        url="https://t.me/+5-0fjVj2h0dmOTcy"
    ))
    builder.add(types.InlineKeyboardButton(
        text="назад",
        callback_data="end_surrey"
