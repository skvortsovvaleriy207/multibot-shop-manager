...
async def send_showcase(chat_id: int):
    ...
    photo_url = "https://autonet.bug.hr/img/tko-kupi-ovaj-bugatti-na-poklon-dobiva--rolls-royce_NByTb_.jpg"
    builder = InlineKeyboardBuilder()
    builder.add(types.InlineKeyboardButton(text="Опрос", url="https://t.me/BestAutoAviaBot"))
    builder.add(types.InlineKeyboardButton(text="Магазин", url="https://t.me/BestAutoAviaBot"))
    builder.adjust(2)
