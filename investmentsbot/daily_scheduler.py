"""
Ежедневный планировщик для синхронизации в 18:00 МСК согласно ТЗ
"""
...
async def start_daily_scheduler():
    """Запуск ежедневного планировщика синхронизации в 18:00 МСК"""
    ...
    while True:
        try:
            ...
            # Устанавливаем целевое время 18:00 МСК
            target_time = now.replace(hour=18, minute=0, second=0, microsecond=0)
            
            # Если уже прошло 18:00, планируем на следующий день
            if now >= target_time:
...
async def daily_sync_task():
    """Ежедневная задача синхронизации в 18:00 МСК"""
    logging.info("🕐 Начинаем ежедневную синхронизацию в 18:00 МСК")
