    ...
    if not user_exists:
        ...
        try:
            ...
            if survey_data:
                ...
                # Run sync in background to avoid blocking? Or await? Logic says await to ensure consistency before menu
                # But sync_db_to_google_sheets in bestsocialbot was awaited.
